 ...
 *
 */
public class BaseTaskTypeAdapter implements JsonSerializer<org.redpin.base.core.Task>,
		JsonDeserializer<org.redpin.base.core.Task> {

	/**
	 * @see JsonSerializer#serialize(Object, Type, JsonSerializationContext)
	 */
	@Override
	public JsonElement serialize(org.redpin.base.core.Task src, Type typeOfSrc,
